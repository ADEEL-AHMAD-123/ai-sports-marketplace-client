...
export const SPORT_CONFIG = {
  ...
  nhl: {
    ...
    injury: {
      supported: true,
      provider: 'espn-nhl-injuries',
      providerLabel: 'ESPN NHL Injuries',
    },
    showPitcherHand: false,
    showEnvironment: false,
  },
  ...
  nfl: {
    ...
    statUnits: {
      ...
      receptions: 'rec',
      pass_tds: 'td',
      rush_reception_yards: 'yds',
    },
    advancedMetrics: ['Yds/G', 'TD/G', 'Target Share'],
    predNote: 'NFL props use short-season windows (form 5, edge 8) with line-aware confidence scoring.',
    badges: {
  ...
  soccer: {
    key: 'soccer', label: 'Soccer', fullName: 'EPL • La Liga • Bundesliga • Serie A • Ligue 1 • MLS', region: 'Global',
    isActive: true,
    leagueId: 39,
    teamBase: 'football',
    leagueLogoUrl: 'https://media.api-sports.io/football/leagues/39.png',
    statLabels: { goals: 'Goals', assists: 'Assists', shots_on_target: 'Shots on Target' },
    statUnits: { goals: 'G', assists: 'A', shots_on_target: 'SOT' },
    advancedMetrics: ['xG', 'Conversion %'],
    predNote: 'Goals, assists, and shots on target across 6 major leagues.',
    badges: {
      highConfidenceLabel: 'HC', bestValueLabel: 'BV',
